...
import com.opensw.mainscreen.databinding.FragmentMatchingSuccessBinding
import com.opensw.mainscreen.databinding.RecyclerCommunityBinding
import com.opensw.mainscreen.mainscreen.Community
import com.opensw.mainscreen.mainscreen.Holder
import java.text.SimpleDateFormat

class CommunityAdapter : RecyclerView.Adapter<CommunityHolder> {

	val listCommunityData = mutableListOf<Community>()
